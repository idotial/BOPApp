...
const ACCESS_CONTROL_MAP = [null, Keychain.ACCESS_CONTROL.DEVICE_PASSCODE, Keychain.ACCESS_CONTROL.APPLICATION_PASSWORD, Keychain.ACCESS_CONTROL.USER_PRESENCE]
    ...
    return (
      ...
      >
        <View style={styles.content}>
          <Text style={styles.title}>{this.state.biometryType}</Text>
        </View>
        <View style={styles.content}>
